...
const translations = {
    pt: {
        ...
        nav_book: "Reservar",
        top_bar_text: "Empresa 100% Portuguesa <span class='desktop-separator'>|</span><br class='mobile-break'> RNAVT 13012 • RNAAT 1188/2024",
        ...
        req_services_title: "Serviços mais requisitados",
        req_services_1_title: "Transfers Norte a Sul",
        req_services_1_desc: "Transfers de norte a sul de Portugal.",
        req_services_2_title: "Transfers para Espanha",
        req_services_2_desc: "Transfers para Espanha.",
        req_services_3_title: "Aeroporto",
        req_services_3_desc: "Monitorização dos voos e receção personalizada.",
        req_services_4_title: "Eventos Privados",
        req_services_4_desc: "Festas, casamentos e jantares.",
        ...
        van7_title: "Carrinha de 7 Lugares",
        van7_subtitle: "Mais uma opção da nossa frota, ideal para grupos pequenos.",
        van7_seats: "Carrinha de 7 lugares",
        van7_pax_luggage: "Até 4 passageiros com bagagens",
        van7_pax_no_luggage: "De 5 a 6 passageiros: sem bagagem",
        boat_cta_title: "Precisa de um Passeio de Barco?",
        boat_cta_desc: "Os passeios de barco e serviços de skipper passaram a ser da responsabilidade da TagusFlow, a nossa empresa parceira.",
        boat_cta_btn: "Visitar TagusFlow.pt",
        ...
        google_review_count: "46 avaliações",
        tourist: "Turista",
        business: "Viajante",
        client: "Cliente",
    ...
    en: {
        ...
        nav_book: "Book Now",
        top_bar_text: "100% Portuguese Company <span class='desktop-separator'>|</span><br class='mobile-break'> RNAVT 13012 • RNAAT 1188/2024",
        ...
        req_services_title: "Most Requested Services",
        req_services_1_title: "North to South Transfers",
        req_services_1_desc: "Transfers from north to south of Portugal.",
        req_services_2_title: "Transfers to Spain",
        req_services_2_desc: "Transfers to Spain.",
        req_services_3_title: "Airport",
        req_services_3_desc: "Flight monitoring and personalized reception.",
        req_services_4_title: "Private Events",
        req_services_4_desc: "Parties, weddings, and dinners.",
        ...
        van7_title: "7-Seater Van",
        van7_subtitle: "Another option from our fleet, ideal for small groups.",
        van7_seats: "7-Seater Van",
        van7_pax_luggage: "Up to 4 passengers with luggage",
        van7_pax_no_luggage: "5 to 6 passengers: no luggage",
        boat_cta_title: "Looking for a Boat Tour?",
        boat_cta_desc: "Boat tours and skipper services are now provided by TagusFlow, our partner company.",
        boat_cta_btn: "Visit TagusFlow.pt",
        ...
        google_review_count: "46 reviews",
        tourist: "Tourist",
        business: "Traveler",
        client: "Client",
    ...
    es: {
        ...
        req_services_title: "Servicios más solicitados",
        req_services_1_title: "Traslados de Norte a Sur",
        req_services_1_desc: "Traslados de norte a sur de Portugal.",
        req_services_2_title: "Traslados a España",
        req_services_2_desc: "Traslados a España.",
        req_services_3_title: "Aeropuerto",
        req_services_3_desc: "Monitoreo de vuelos y recepción personalizada.",
        req_services_4_title: "Eventos Privados",
        req_services_4_desc: "Fiestas, bodas y cenas.",
        ...
        van7_title: "Furgoneta de 7 Plazas",
        van7_subtitle: "Otra opción de nuestra flota, ideal para grupos pequeños.",
        van7_seats: "Furgoneta de 7 plazas",
        van7_pax_luggage: "Hasta 4 pasajeros con equipaje",
        van7_pax_no_luggage: "De 5 a 6 pasajeros: sin equipaje",
        boat_cta_title: "¿Busca un Paseo en Barco?",
        boat_cta_desc: "Los paseos en barco y los servicios de patrón ahora los ofrece TagusFlow, nuestra empresa asociada.",
        boat_cta_btn: "Visitar TagusFlow.pt",
        ...
        google_review_count: "46 reseñas",
        tourist: "Turista",
        business: "Viajero",
        client: "Cliente",
    ...
    fr: {
        ...
        nav_book: "Réserver",
        top_bar_text: "Entreprise 100% Portugaise <span class='desktop-separator'>|</span><br class='mobile-break'> RNAVT 13012 • RNAAT 1188/2024",
        ...
        req_services_title: "Services les plus demandés",
        req_services_1_title: "Transferts du Nord au Sud",
        req_services_1_desc: "Transferts du nord au sud du Portugal.",
        req_services_2_title: "Transferts vers l'Espagne",
        req_services_2_desc: "Transferts vers l'Espagne.",
        req_services_3_title: "Aéroport",
        req_services_3_desc: "Suivi des vols et accueil personnalisé.",
        req_services_4_title: "Événements Privés",
        req_services_4_desc: "Fêtes, mariages et dîners.",
        ...
        van7_title: "Van de 7 Places",
        van7_subtitle: "Une autre option de notre flotte, idéale pour les petits groupes.",
        van7_seats: "Van de 7 places",
        van7_pax_luggage: "Jusqu'à 4 passagers avec bagages",
        van7_pax_no_luggage: "De 5 à 6 passagers : sans bagage",
        boat_cta_title: "Vous cherchez une Balade en Bateau ?",
        boat_cta_desc: "Les balades en bateau et les services de skipper sont désormais assurés par TagusFlow, notre entreprise partenaire.",
        boat_cta_btn: "Visiter TagusFlow.pt",
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (navbar && topBar) {
        // Optimization: IntersectionObserver eliminates Forced Synchronous Layout by moving calculations off the main thread.
        const topBarObserver = new IntersectionObserver(([entry]) => {
        ...
        setTimeout(() => {
            if (opt.action === 'quote') {
                ...
                renderOptions([
                    ...
                    { text: t.req_services_1_title, action: 'set_dest_Transfers Norte a Sul' },
                    { text: t.req_services_2_title, action: 'set_dest_Transfers para Espanha' },
                    { text: t.req_services_3_title, action: 'set_dest_Aeroporto' },
                    { text: t.req_services_4_title, action: 'set_dest_Eventos Privados' },
                    { text: t.chat_opt_other || "Outro/Other", action: 'set_dest_Outro' }
                ]);
            }
